...
router.post('/api/search', async function(req,res){ // body로 넘겨준 값을 가지고 맞는 디비 리스트를 json 형식으로 보내줌
...
router.get('/api/pharmacy',async function(req,res,next){
...
router.post('/api/pharmacy/name',async function(req,res,next){
  //console.log(req.body.symptom)
...
router.post('/api/pharmacy/company',async function(req,res,next){
