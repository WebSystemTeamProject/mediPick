...
<script>
    ...
    export default {
        ...
        async created(){
            ...
            this.$http.post('http://localhost:80/review/list',{
                id : this.item._id
            }).then((response) => {
        ...
        methods : {
            submit(){
                ...
                this.$http.post('http://localhost:80/review/submit', {
                    ...
                    this.$http.post('http://localhost:80/review/list',{
                        ...
                        this.list = response.data;
                        this.$http.post('http://localhost:80/mediManage/update_comment',{
            ...
            remove(info){
                this.$http.post('http://localhost:80/review/remove',{
                    id : info._id,
                    medi_id : this.item._id
                }).then((response)=>{
                    this.content = "";
            ...
            rew(info){
                ...
                this.$http.post('http://localhost:80/review/update',{
                    id : info._id,
                    medi_id : this.item._id,
